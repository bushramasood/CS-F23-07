                ...
                <div className='w-full max-w-3xl'>
                    {
                        loading ? (
                            ...
                            data.map((product, index) => {
                                return (
                                    <div key={product?._id + "Add To Cart Loading"} className='w-full bg-white my-2 border border-slate-300 rounded'>
                                        <div className='grid grid-cols-[128px,1fr]'>
                                            ...
                                            <div className='px-4 py-2 relative'>
                                                ...
                                                <div className='flex items-center justify-between'>
                                                    ...
                                                    <p className='text-red-600 font-semibold text-lg'>{displayPKRCurrency(product?.productId?.sellingPrice * product?.quantity)}</p>
                                                </div>
                ...
                <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                    {
                        loading ? (
                            ...
                            <div className='h-36 bg-white'>
                                ...
                                <Link to="/shipping" className='bg-goldenrod hover:bg-goldenrod-darker p-2 text-white w-full mt-2 block text-center'>Proceed</Link>
                            </div>
                        )
                    }
                </div>
